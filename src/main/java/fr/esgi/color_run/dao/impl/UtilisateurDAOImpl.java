...
public class UtilisateurDAOImpl implements UtilisateurDAO {
    ...
    public void delete(Integer id) throws DAOException {
        ...
        try {
            ...
            if (affectedRows == 0) {
                throw new DAOException("La suppression de l'utilisateur a échoué, aucun utilisateur trouvé avec l'ID: " + id);
            }
    ...
    public boolean verifyPassword(String email, String password) throws DAOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Dans une application réelle, il faudrait utiliser un algorithme de hachage comme BCrypt
