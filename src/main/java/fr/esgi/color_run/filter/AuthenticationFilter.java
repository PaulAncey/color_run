...
public class AuthenticationFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        // Initialiser le service utilisateur (dans une application réelle, utiliser l'injection de dépendances)
        // utilisateurService = new UtilisateurServiceImpl(new UtilisateurDAOImpl(), new RoleDAOImpl(), new UtilisateurRoleDAOImpl());
    }
